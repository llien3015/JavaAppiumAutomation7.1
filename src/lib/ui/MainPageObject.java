...
public class MainPageObject
{
    ...
    public WebElement waitForElementPresent(String locator, String error_message) {
        return waitForElementPresent(locator, error_message, 30);
    }
    ...
    public WebElement waitForElementAndSetValue(String locator, String value, String errorMessage, long timeoutInSeconds) {
    ...
    private By getLocatorByString(String locator_with_type)
    {
        ...
        if (by_type.equals("xpath")){
            ...
            throw new IllegalArgumentException("Cannot get typ of locator: " + locator_with_type);
        }
    }
